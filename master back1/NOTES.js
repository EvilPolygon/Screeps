...
-------       Фичи          ---------
(_.forEach(Game.rooms['W24N1'].findPath(new RoomPosition(28,25,'W24N1'),new RoomPosition(25,1,'W24N1')), Pos => {Game.rooms['W24N1'].createConstructionSite(Pos.x, Pos.y, STRUCTURE_ROAD);}))
